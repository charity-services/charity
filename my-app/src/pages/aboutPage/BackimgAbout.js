...
import hero from  "./images/rescue-hero.jpg"
import aboutone from  "./images/aboutone.jpg"
import aboutwo from  "./images/aboutwo.jpg"
 ...
 <section
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
    ...
    <div className="grid gap-10 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mb-10">
      ...
      <div className=" grid place-items-center gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
