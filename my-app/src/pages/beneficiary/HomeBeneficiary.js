...
const HomeBeneficiary = () => {
      ...
      <div className="flex justify-center items-center">
        <div className="2xl:mx-auto 2xl:container lg:px-20 lg:py-16 md:py-12 md:px-6 py-9 px-4 w-96 sm:w-auto">
          <div className="flex flex-col items-center justify-center">
            <h1 className="text-4xl font-semibold leading-9 text-center animate-pulse text-gray-800">This Week Blogs</h1>
          ...
          <div className="lg:flex items-stretch md:mt-12 mt-8">
            <div className="lg:w-1/2">
              <div className="sm:flex items-center justify-between xl:gap-x-8 gap-x-6">
                <div className="sm:w-1/2 relative  transition duration-300 ease-in-out hover:scale-110">
                  ...
                  <img src="https://images.unsplash.com/photo-1522521612083-730fb19791c1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1171&q=80" className=" w-[530px] h-[250px]" alt="chair" />
                </div>
                <div className="sm:w-1/2 sm:mt-0 mt-4 relative  transition duration-300 ease-in-out hover:scale-110">
                  ...
                  <img src="https://images.unsplash.com/photo-1544568100-847a948585b9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80" className="w-[530px] h-[250px]" alt="wall design" />
                </div>
              </div>
              <div className="relative  transition duration-300 ease-in-out hover:scale-105">
                ...
                <img src="https://images.unsplash.com/photo-1564349683136-77e08dba1ef7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1172&q=80" alt="sitting place" className=" mt-8 md:mt-6 w-full h-[548px] hidden sm:block" />
              </div>
            </div>
            <div className="lg:w-1/2 xl:ml-8 lg:ml-4 lg:mt-0 md:mt-6 mt-4 lg:flex flex-col justify-between">
              <div className="relative transition duration-300 ease-in-out hover:scale-105">
                ...
                <img src="https://images.unsplash.com/photo-1473216635433-38f7100ae658?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1197&q=80" alt="sitting place" className="   w-full h-[548px] hidden sm:block" />
 ...
 font-semibold mt-4 md:mt-10">
            ...
            <p className="my-3  text-justify font-medium text-gray-700 leading-relaxed">
              Animal care ensures the physical and emotional well-being of animals through proper nutrition, shelter, and medical attention, promoting a healthy and fulfilling life for them.
            </p>
  ...
  <label for="don" className='font-bold'>Donation case : </label>
                ...
                <label for="don1" className='font-bold'>Type of Donate : </label>
                <select
                id="don1"
                  value={donationType}
