...
const LINKS = [
  {
    title: "Quick Links",
    items: ["Home", "Overview", "Donate", "Benifit"],
  },
  {
    title: "Know More",
    items: ["Who we are", "Why us", "Contact us" , "News"],
  },
  {
    title: "Resource",
...
const Footer = () => {
  ...
  Give Life
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="#">Give Life</a>. All
            Rights Reserved.
          </Typography>
          ...
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            ...
            <Typography as="a" href="https://github.com/saad-zireeni" className="opacity-80 transition-opacity hover:opacity-100">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fill-rule="evenodd"
